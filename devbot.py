...
if choice == "N" or choice == "n":
   accessToken = input("Please provide your token ")
   accessToken = "Bearer " + accessToken
else:
   accessToken = "Bearer YjE1ZDFjODUtZjZhOC00MGQ4LTllOWEtMmNjZDRmOWVmYmY1ZmVjZmNkYzItNWJi_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "OoR1aDPnn8vKe0u8uzto1syj2pNfq4gr"
                               }
